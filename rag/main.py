...
docs = loader.load()
train = [Document(page_content=x.page_content.split('[/INST]')[1]) for x in docs[:-1000]]
test = [Document(page_content=x.page_content.split('<</SYS>>')[2]) for x in docs[-1000:]]
